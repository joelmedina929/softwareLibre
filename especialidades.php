...
<nav class="navbar navbar-inverse">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-Success Dark">
...
<body>
  ...
  <img src="img/especial-removebg-preview.png" align="center" style="width: 70%; margin-top: 0px; height: 500px; margin-bottom: 20px; margin-left: 15%">
